...
import (
	...
	"myopenfactory.io/x/app/tatooine/pkg/transport"
	"myopenfactory.io/x/app/tatooine/pkg/transport/file"
)
...
func (c *Client) Run() error {
	...
	clientpb := pb.NewCoreServiceProtobufClient(c.URL, c.client)
...
func sendHealthInformation(ctx context.Context, srv pb.CoreService, id string, start time.Time, notAfter time.Time) {
